...
We're excited to announce the **v0.2.0** release of AIBrix! Building on feedback from [v0.1.0](/posts/2024-11-12-v0.1.0-release/) production adoption and user interest, this release introduces several new features to enhance performance and usability.
